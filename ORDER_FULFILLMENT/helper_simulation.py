...
def evaluate_policies(n_max, T, alpha, instance, num_order_sequences=100, num_items=20, n_0=5, p_stock=0.75, conservative_prob_sequence=[0, 0.2, 1]):
    ...
    order_fulfillment = OrderFulfillment(num_items, n_max, n_0, p_stock, T, prob_seed_value = instance, order_seed_value= instance, inv_seed_value= instance, alpha = alpha)
