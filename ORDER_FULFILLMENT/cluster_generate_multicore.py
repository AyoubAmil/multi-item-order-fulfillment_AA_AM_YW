...
slurm_dir = f'slurm_instance_{instance}_multicore'
...
with open('ORDER_FULFILLMENT/cluster_simulation_multicore.py', 'r') as f:
    line = f.readline()
    while line:
        script.append(line)
        line = f.readline()
...
for n_max in n_max_values:
    for T in T_values:
        for alpha in alpha_values:
            ...
            new_script.append(r'n_max = %s' % n_max + '\n')
            new_script.append(r'T = %s' % T + '\n')
            new_script.append(r'alpha = %s' % alpha + '\n')
            new_script.append(r'instance = %s' % instance + '\n')
                        
            new_script = new_script + end_script
